...
class Material(object):
    def __init__(self, m, k_a, k_d, k_s):
        self.m = m
        self.k_a = k_a		#[Ka_r, Ka_g, Ka_b]
        self.k_d = k_d		#[Kd_r, Kd_g, Kd_b]
        self.k_s = k_s 		#[Ks_r, Ks_g, Ks_b]
...
class Face(object):
    ...
    def find_Pin(self, ray):
        ...
        x = ray.point2.coordinates[0] * t 
        y = ray.point2.coordinates[1] * t
        z = ray.point2.coordinates[2] * t
        Pin = Point("Pin", [x, y, z, 1])
